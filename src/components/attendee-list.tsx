        ...
        <div className="flex flex-col gap-4">
            <div className="flex gap-3 items-center">
                ...
                <div className="w-72 px-3 py-1.5 border border-white/10 rounded-lg flex items-center gap-3">
                    ...
                    <input onChange={onSearchInputChaged} className="bg-transparent flex-1 outline-none h-auto border-0 p-0 text-sm" placeholder="Buscar participante..." />
                </div>
                {search}
            </div>
            ...
            <Table>
                ...
                <tbody>
                    {attendees.slice((page - 1) * 10, page * 10).map((attendees) => {
                        return (<TableRow key={attendees.id}>
                            <TableCell>
                                <input className='size-4 bg-black/20 rounded border border-white/10 ' type="checkbox" />
                            </TableCell>
